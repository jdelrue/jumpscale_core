...
- line new : 'JSConfigFactoryBase = j.tools.configmanager.JSBaseClassConfigs'
, ##### line change [2]
...
- line new : 'JSConfigClientBase = j.tools.configmanager.JSBaseClassConfig'
, ##### line change [2]
...
- line new : 'JSConfigBase = j.tools.configmanager.JSBaseClassConfig'
, ##### line change [0]
...
- line new : 'JSConfigBase = j.tools.configmanager.JSBaseClassConfigs'
]
```
