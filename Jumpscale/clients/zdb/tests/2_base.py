...
def main(self):
    ...
    js_shell 'j.clients.zdb.test(name="base",start=True)'
    ...
    self.logger.debug("write 10000 entries")
    ...
    self.logger.debug("count:%s" % cl.count)
    ...
    self.logger.debug("perftest for 10.000 records, should get above 5k per sec, +10k expected")
    ...
    self.logger.info("PERF TEST SEQ OK")
    return "OK"
