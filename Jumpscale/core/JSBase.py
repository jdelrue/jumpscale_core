...
# activate when camel-to-snake conversion is needed
#from .JSBaseMixCamelSnake import CamelSnakeConvert
...
#class JSBase(BaseGetter, CamelSnakeConvert):
class JSBase(BaseGetter):
    ...
    # XXX ENABLE ONLY WHEN camelCase_to_snake_case is needed
    #def __getattr__(self, attrname):
    #   return CamelSnakeConvert.__getattr__(self, attrname)
