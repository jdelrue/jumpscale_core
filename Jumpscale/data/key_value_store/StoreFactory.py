...
class StoreFactory(JSBASE):
    ...
    def getPickleDBStore(self, name="core", namespace='db', baseDir='/tmp', serializers=[]):
        from Jumpscale.data.key_value_store.pickledb_store import PickleDBStore
    ...
    def getARDBStore(
        ...
        @rtype: MemoryKeyValueStore
        '''
        from Jumpscale.data.key_value_store.ardb_store import ARDBKeyValueStore
    ...
    def getRocksDBStore(self, name, namespace='db', dbpath="/tmp/kvs.db",
        ...
        '''
        from Jumpscale.data.key_value_store.rocksdb_store import RocksDBKeyValueStore
    ...
    #     @return: key value store
    #     '''
    #     from Jumpscale.data.key_value_store.tarantool_store import TarantoolStore
    #     if name not in self._cache:
